    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4">
        <span
          ...
          style={{ background: 'color-mix(in srgb, var(--color-gold) 12%, transparent)', color: 'var(--color-gold)', border: '1px solid color-mix(in srgb, var(--color-gold) 25%, transparent)' }}
        >
      ...
      {!submitted ? (
        ...
        <div>
          <div
            ...
            style={{ background: 'color-mix(in srgb, var(--color-blue) 6%, transparent)', border: '1px solid color-mix(in srgb, var(--color-blue) 18%, transparent)', color: 'var(--color-text)' }}
          >
            "{input}"
          </div>
