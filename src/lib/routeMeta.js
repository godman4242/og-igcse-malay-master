...
export const ROUTE_META = {
  ...
  '/privacy':         { name: 'Privacy Policy', index: true,  title: 'Privacy Policy | IGCSE Malay Master', description: 'What IGCSE Malay Master collects, what it never collects, who else receives it, and how to delete everything.' },
  '/terms':           { name: 'Terms of Use',   index: true,  title: 'Terms of Use | IGCSE Malay Master', description: 'The terms for using IGCSE Malay Master — a free IGCSE revision aid. What it does, what it cannot promise, and what is expected of you.' },
