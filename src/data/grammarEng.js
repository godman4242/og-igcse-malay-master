...
export const ARTICLE_DRILLS_EN = [
  ...
  { id: 'eng-art-information', sentence: 'I need ___ information about the scholarship deadline.', options: ['a', 'an', 'some', 'an'], answer: 'some', rule: '"Information" is uncountable. Use "some" instead of "a / an".' },
