...
import { FileText, ChevronDown, ChevronUp, Sparkles, Loader2, AlertCircle, Plus, Volume2, Award } from 'lucide-react'
...
export default function Writing() {
  ...
  return (
    <div className="space-y-3 animate-fadeUp">
      ...
      {/* Band-6 exemplar — shown when a specific format is selected */}
      {lang !== 'templates' && (() => {
        const resolvedFormat = format !== 'auto' && format !== 'general'
          ? format
          : (format === 'auto' && liveDetected ? liveDetected.format.id : null)
        const exemplar = resolvedFormat ? getExemplar(resolvedFormat) : null
        return exemplar ? <ExemplarPanel exemplar={exemplar} /> : null
      })()}
...
function ExemplarPanel({ exemplar }) {
