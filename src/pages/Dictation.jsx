    ...
    return (
      <div className="space-y-4 animate-fadeUp">
        ...
        <div>
          ...
          <div className="flex gap-2" role="group" aria-label="Dictation language" data-guide="dictation-lang">
        ...
        <button onClick={start} disabled={!ttsSupported} data-guide="dictation-start"
