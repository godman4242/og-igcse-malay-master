...
export const WRITING_GOLD_EN = [
  // ───────────────────────────── WEAK (band 2–3) ─────────────────────────────
  {
    ...
    errors: [
      { span: 'teenager have', category: 'sva', correct: 'teenager has', note: 'Singular subject "teenager" takes "has". Noun-subject agreement — left to BYOK.', regexExpected: false },
  ...
  },
  {
    ...
    format: 'eng-article',
    intendedBand: 4,
    text: `School uniforms are a topic that many students argue about. Some say that uniforms remove their freedom, while others believe they bring equality. In my school, the teachers gives us many homeworks every weekend. My best friend dont like wearing a tie, but she follow the rules anyway. Personally, I think a smart appearance helps us to focus on our studies.`,
    errors: [
      { span: 'teachers gives', category: 'sva', correct: 'teachers give', note: 'Plural subject "teachers" takes "give". Plural-noun-subject agreement — left to BYOK.', regexExpected: false },
  ...
  },
  {
    ...
    format: 'eng-report',
    intendedBand: 5,
    text: `This report examines how technology has changed the way we study. Most students now use laptops and tablets instead of books. The school recently bought new equipments for the computer lab. Technology is definately a useful tool, and the survey show that students learn faster with videos. According with these findings, the school should invest in more devices. Although technology brings many benefits, it cannot replace a dedicated teacher.`,
    errors: [
