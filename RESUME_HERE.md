...
### → THE KICKOFF: SEO epic Phase 2 — crawler-facing SEO (Kheshav chose PUBLIC / search-discovery 2026-07-14). Quick-wins already shipped; NEXT = build-time prerender + canonical/`noindex`-mirror + per-page H1. Needs a research→plan→build session (touches the prod build pipeline — don't rush).
